...
export const questions: Question[] = [
  q(1,"التعريف بالنفس","B1","Können Sie sich bitte kurz vorstellen?","هل يمكنك تقديم نفسك باختصار؟","Guten Tag. Mein Name ist [Name], ich komme aus [Land/Stadt] und habe [Studium/Ausbildung] abgeschlossen. Ich spreche Arabisch, Deutsch und Englisch. Durch [Arbeit/Studium] habe ich Erfahrung im Umgang mit Menschen gesammelt. Ich bin zuverlässig, lernbereit und möchte mich im Kundenservice langfristig weiterentwickeln.","مرحبًا. اسمي [الاسم]، وأنا من [البلد/المدينة] وقد أنهيت [الدراسة/التدريب]. أتحدث العربية والألمانية والإنجليزية. ومن خلال [العمل/الدراسة] اكتسبت خبرة في التعامل مع الناس. أنا شخص يعتمد عليه وسريع التعلم وأريد التطور طويلًا في خدمة العملاء."),
