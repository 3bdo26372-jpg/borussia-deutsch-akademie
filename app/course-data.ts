...
const learningText = (word: string, category: string, index: number) => {
  const templates: Record<string, { examples: string[]; situations: string[] }> = {
    "الطلبات والشحن": {
      examples: [
        `Für diese Bestellung ist „${word}“ besonders wichtig.`,
        `Ich prüfe „${word}“ direkt im Bestellsystem.`,
        `Die Kundin fragt heute nach „${word}“.`,
        `Im Versandbericht steht der Eintrag „${word}“.`,
      ],
      situations: [
        `Kunde: Ich habe eine Frage zu „${word}“. Mitarbeiter: Gern, ich prüfe sofort den aktuellen Stand.`,
        `Kunde: Können Sie „${word}“ kontrollieren? Mitarbeiter: Ja, einen Moment bitte.`,
        `Mitarbeiter: Bei Ihrer Bestellung muss ich „${word}“ noch prüfen. Kunde: Danke für die Information.`,
      ],
    },
    "الإرجاع والاستبدال": {
      examples: [
        `Bei dieser Reklamation besprechen wir „${word}“.`,
        `Ich erkläre der Kundin den Ablauf mit „${word}“.`,
        `Als passende Lösung prüfen wir „${word}“.`,
        `Der nächste Schritt betrifft „${word}“.`,
      ],
      situations: [
        `Kunde: Welche Lösung gibt es? Mitarbeiter: Ich erkläre Ihnen jetzt „${word}“.`,
        `Mitarbeiter: Für Ihren Fall können wir „${word}“ prüfen. Kunde: Wie lange dauert das?`,
        `Kunde: Was muss ich wegen „${word}“ tun? Mitarbeiter: Ich führe Sie Schritt für Schritt durch den Ablauf.`,
      ],
    },
    "الدفع والفواتير": {
      examples: [
        `Auf der Rechnung prüfe ich „${word}“ besonders sorgfältig.`,
        `Die Buchhaltung kontrolliert heute „${word}“.`,
        `Im Zahlungsvorgang ist „${word}“ klar dokumentiert.`,
        `Ich erkläre dem Kunden den Begriff „${word}“.`,
      ],
      situations: [
        `Kunde: Auf meiner Rechnung steht „${word}“. Mitarbeiter: Ich prüfe den Eintrag sofort.`,
        `Mitarbeiter: Für die Zahlung brauche ich Angaben zu „${word}“. Kunde: Ich sende Ihnen die Informationen.`,
        `Kunde: Können Sie „${word}“ erklären? Mitarbeiter: Ja, ich zeige Ihnen die Buchung im Detail.`,
      ],
    },
    "خدمة العملاء": {
      examples: [
        `Im Kundenservice ist „${word}“ ein wichtiger Ausdruck.`,
        `Ich verwende „${word}“ in einem professionellen Gespräch.`,
        `Eine gute Lösung beginnt hier mit „${word}“.`,
        `Die Mitarbeiterin dokumentiert „${word}“ im System.`,
      ],
      situations: [
        `Kunde: Ich brauche Hilfe mit „${word}“. Mitarbeiter: Gern, ich kümmere mich darum.`,
        `Mitarbeiter: Darf ich kurz nach „${word}“ fragen? Kunde: Ja, natürlich.`,
        `Kunde: Was passiert bei „${word}“? Mitarbeiter: Ich erkläre Ihnen den nächsten Schritt.`,
      ],
    },
    "الهاتف والدعم التقني": {
      examples: [
        `Der technische Support prüft „${word}“ im System.`,
        `Am Telefon erkläre ich „${word}“ langsam und deutlich.`,
        `Für dieses Ticket dokumentiere ich „${word}“.`,
        `Die Fachabteilung benötigt Informationen zu „${word}“.`,
      ],
      situations: [
        `Kunde: Mein Problem betrifft „${word}“. Mitarbeiter: Welche Meldung sehen Sie genau?`,
        `Mitarbeiter: Ich prüfe jetzt „${word}“. Kunde: Soll ich am Telefon bleiben?`,
        `Kunde: Können Sie mir bei „${word}“ helfen? Mitarbeiter: Ja, wir gehen die Schritte gemeinsam durch.`,
      ],
    },
    "المقابلة والعمل": {
      examples: [
        `Im Bewerbungsgespräch spreche ich offen über „${word}“.`,
        `Für diese Position ist „${word}“ besonders relevant.`,
        `Mein Beispiel aus der Praxis zeigt „${word}“.`,
        `Die Frage zu „${word}“ beantworte ich mit einem konkreten Beispiel.`,
      ],
      situations: [
        `Interviewer: Was können Sie zu „${word}“ sagen? Bewerber: Gern nenne ich Ihnen ein konkretes Beispiel.`,
        `Bewerber: Für meine Arbeit ist „${word}“ wichtig. Interviewer: Wie zeigen Sie das in der Praxis?`,
        `Interviewer: Welche Erfahrung haben Sie mit „${word}“? Bewerber: Ich erkläre Ihnen kurz eine passende Situation.`,
      ],
    },
    "B2 والحياة اليومية": {
      examples: [
        `In der B2-Diskussion verwende ich „${word}“ bewusst.`,
        `Mein Argument zum Alltag enthält „${word}“.`,
        `Im Text wird „${word}“ mit einem Beispiel erklärt.`,
        `Mit „${word}“ formuliere ich meine Meinung genauer.`,
      ],
      situations: [
        `Prüfer: Wie verwenden Sie „${word}“? Teilnehmer: Ich gebe dazu ein Beispiel aus dem Alltag.`,
        `Teilnehmer: Mein nächster Punkt ist „${word}“. Prüfer: Bitte erklären Sie Ihre Meinung.`,
        `Prüfer: Was bedeutet „${word}“ in diesem Zusammenhang? Teilnehmer: Ich erkläre es mit einem kurzen Beispiel.`,
      ],
    },
  };
